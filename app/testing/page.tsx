            ...
            <div key={answer.row} className="grid grid-cols-[5rem_1fr_1fr] gap-4 items-center py-2">
              ...
              <div>
                <input
                  ...
                  className={`w-full px-3 py-2 border-2 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 text-base text-gray-900 ${
...
function MockScoring() {
  const [rowAnswers, setRowAnswers] = useState([
    {
      ...
      initials: 'AZ',
      playerAnswers: [
        { playerName: 'Alice', teamNumber: 1, answers: ['Apple', 'Zebra'], score: 1 }, // Duplicate with Bob = 1
        { playerName: 'Bob', teamNumber: 1, answers: ['Apple', 'Zebra'], score: 1 },   // Duplicate with Alice = 1
        { playerName: 'Charlie', teamNumber: 2, answers: ['Ant', 'Zone'], score: 3 },  // Unique, others answered = 3
      ]
    },
    {
      rowNumber: 1,
      initials: 'BY',
      playerAnswers: [
        { playerName: 'Alice', teamNumber: 1, answers: ['Banana', 'Yellow'], score: 5 }, // Only answer = 5
        { playerName: 'Bob', teamNumber: 1, answers: [], score: 0 },                      // No answer = 0
        { playerName: 'Charlie', teamNumber: 2, answers: [], score: 0 },                  // No answer = 0
      ]
    },
    {
      rowNumber: 2,
      initials: 'CX',
      playerAnswers: [
        { playerName: 'Alice', teamNumber: 1, answers: ['Cat', 'Xray'], score: 3 },       // Unique, others answered = 3
        { playerName: 'Bob', teamNumber: 1, answers: ['Car', 'Xerox'], score: 3 },        // Unique, others answered = 3
        { playerName: 'Charlie', teamNumber: 2, answers: ['Cup', 'Xylophone'], score: 3 }, // Unique, others answered = 3
      ]
    },
  ]);
  ...
  const calculateTeamTotals = () => {
    ...
    return Object.entries(playerTotals).sort((a, b) => b[1] - a[1]);
  };
    ...
    <main className="flex min-h-screen flex-col p-6 bg-gray-900">
      ...
      <div className="w-full max-w-6xl mx-auto mb-6">
        <div className="bg-gray-800 rounded-lg p-4 flex gap-4 justify-center flex-wrap">
          ...
          <Link
            href="/initiate"
            className="px-4 py-2 rounded-md font-semibold bg-gray-700 text-gray-300 hover:bg-gray-600 transition-colors"
          >
            Initiate Page
          </Link>
          <Link
